...
public class BlockSilverFurnace extends BlockContainer
{
    ...
    public BlockSilverFurnace(int id, boolean flag)
    {
    ...
    public int getBlockTexture(IBlockAccess iblockaccess, int i, int j, int k, int l)
	{
		if(l == 1)
		{
			return mod_CocoCraft.SilverFurnaceSide;
		}
		if(l == 0)
		{
			return mod_CocoCraft.SilverFurnaceSide;
        ...
        {
            return mod_CocoCraft.SilverFurnaceFront;
        }
	}
	...
	public boolean blockActivated(World world, int i, int j, int k, EntityPlayer entityplayer)
    {
        ...
        if(!world.isRemote)
        {
            entityplayer.openGui(mod_CocoCraft.getInstance(), 2, world, i, j, k);
            return true;
        }
        return true;
    }
