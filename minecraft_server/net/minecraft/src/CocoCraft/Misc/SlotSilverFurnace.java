...
public class SlotSilverFurnace extends Slot
{
    
    private EntityPlayer thePlayer;
    private int field_48437_f;

    public SlotSilverFurnace(EntityPlayer par1EntityPlayer, IInventory par2IInventory, int par3, int par4, int par5)
    {
