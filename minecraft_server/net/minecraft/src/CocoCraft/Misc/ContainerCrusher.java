...
public class ContainerCrusher extends Container
{
    ...
    public ContainerCrusher(InventoryPlayer par1InventoryPlayer, TileEntityCrusher par2TileEntityCrusher)
    {
        ...
        this.addSlot(new Slot(par2TileEntityCrusher, 0, 56, 17));
        this.addSlot(new Slot(par2TileEntityCrusher, 1, 56, 53));
        this.addSlot(new SlotFurnace(par1InventoryPlayer.player, par2TileEntityCrusher, 2, 116, 35));
        int var3;
    ...
    public ItemStack transferStackInSlot(int par1)
    {
        ...
        if (var3 != null && var3.getHasStack())
        {
            ...
            {
                if (CrusherRecipes.smelting().getCrushingResult(var4.getItem().shiftedIndex) != null)
                {
                ...
                else if (TileEntityCrusher.func_52005_b(var4))
                {
