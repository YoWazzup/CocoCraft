...
{
    private TileEntitySilverFurnace furnace;
    private int lastCookTime;
    private int lastBurnTime;
    private int lastItemBurnTime;

    public ContainerSilverFurnace(InventoryPlayer inventoryplayer, TileEntitySilverFurnace tileentityfurnace)
    {
        lastCookTime = 0;
        lastBurnTime = 0;
        lastItemBurnTime = 0;
        furnace = tileentityfurnace;
        this.addSlot(new Slot(tileentityfurnace, 0, 33, 17));
        this.addSlot(new Slot(tileentityfurnace, 1, 45, 53));
        this.addSlot(new Slot(tileentityfurnace, 3, 56, 17));
