...
import net.minecraft.src.CocoCraft.Misc.GuiCompressor;
import net.minecraft.src.CocoCraft.Misc.GuiCrusher;
import net.minecraft.src.CocoCraft.Misc.GuiDuplicator;
import net.minecraft.src.CocoCraft.Misc.GuiSilverFurnace;
import net.minecraft.src.CocoCraft.Misc.TileEntityAlloynizer;
import net.minecraft.src.CocoCraft.Misc.TileEntityCompressor;
import net.minecraft.src.CocoCraft.Misc.TileEntityCrusher;
import net.minecraft.src.CocoCraft.Misc.TileEntityDuplicator;
import net.minecraft.src.CocoCraft.Misc.TileEntitySilverFurnace;
import net.minecraft.src.CocoCraft.Mobs.*;
...
public class mod_CocoCraft extends NetworkMod implements IGuiHandler{
	...
	static int DuplicatorID;
	static int AlloynizerID;
	...
	public static int AlloynizerSide = ModLoader.addOverride("/terrain.png", "/CC/Blocks/AlloynizerSide.png");
	public static int AlloynizerFront = ModLoader.addOverride("/terrain.png", "/CC/Blocks/AlloynizerFront.png");
	...
	//public static final Block Block = (new CC_BlockBlock(IngotBlocksID)).setHardness(1.0F).setResistance(2F).setBlockName("MultiBlock").setRequiresSelfNotify();
	...
	public static final Block Duplicator = (new BlockDuplicator(DuplicatorID, false).setHardness(1F).setResistance(2F).setBlockName("Duplicator"));
	public static final Block Alloynizer = (new BlockAlloynizer(AlloynizerID, false).setHardness(1F).setResistance(2F).setBlockName("Alloynizer"));
	...
	public static final Item BookOfLightning = (new CC_BookOfLightning(BookOfLightningID)).setIconCoord(14, 3).setItemName("BookOfLightning");	
	...
	/**
	ModLoader.addName(new ItemStack(Block, 1, 0), "Coco Block");
	ModLoader.addName(new ItemStack(Block, 1, 1), "Mithril Block");
	ModLoader.addName(new ItemStack(Block, 1, 2), "Silver Block");
	ModLoader.addName(new ItemStack(Block, 1, 3), "Amethyst Block");
	
	ModLoader.addName(CocoBlock, "Coco Block");
	...
	**/
	ModLoader.addName(CocoaFlower, "Cocoa Flower");
	ModLoader.addName(SuperStone, "Super Stone");
	ModLoader.addName(CocoReed, "Coco Reed");
	ModLoader.addName(Essence, "Essence");
	ModLoader.addName(Crusher, "Crusher");
	ModLoader.addName(Compressor, "Compressor");
	ModLoader.addName(SilverFurnace, "Silver Furnace");
	ModLoader.addName(Duplicator, "Duplicator");
	ModLoader.addName(Alloynizer, "Alloynizer");
	...
	ModLoader.addName(CocoHelmet, "Coco Helmet");
	ModLoader.addName(CocoPlate, "Coco Plate");
	ModLoader.addName(CocoLegs, "Coco Legs");
	ModLoader.addName(CocoBoots, "Coco Boots");
	
	ModLoader.addName(MithrilHelmet, "Mithril Helmet");
	ModLoader.addName(MithrilPlate, "Mithril Plate");
	ModLoader.addName(MithrilLegs, "Mithril Legs");
	ModLoader.addName(MithrilBoots, "Mithril Boots");
	
	ModLoader.addName(SilverHelmet, "Silver Helmet");
	ModLoader.addName(SilverPlate, "Silver Plate");
	ModLoader.addName(SilverLegs, "Silver Legs");
	ModLoader.addName(SilverBoots, "Silver Boots");
	
	ModLoader.addName(AmethystHelmet, "Amethyst Helmet");
	ModLoader.addName(AmethystPlate, "Amethyst Plate");
	ModLoader.addName(AmethystLegs, "Amethyst Legs");
	ModLoader.addName(AmethystBoots, "Amethyst Boots");
	
	ModLoader.addName(AlloyHelmet, "Alloy Helmet");
	ModLoader.addName(AlloyPlate, "Alloy Plate");
	ModLoader.addName(AlloyLegs, "Alloy Legs");
	ModLoader.addName(AlloyBoots, "Alloy Boots");
	
	ModLoader.addName(ExtremeAlloyHelmet, "Extreme Alloy Helmet");
	ModLoader.addName(ExtremeAlloyPlate, "Extreme Alloy Plate");
	ModLoader.addName(ExtremeAlloyLegs, "Extreme Alloy Legs");
	ModLoader.addName(ExtremeAlloyBoots, "Extreme Alloy Boots");
	
	ModLoader.addName(Alloy, "Alloy");
	ModLoader.addName(CompressedAlloy, "Compressed Alloy");
	ModLoader.addName(ExtremeAlloy, "Extreme Alloy");
	ModLoader.addName(UncExtremeAlloy, "Uncooked Extreme Alloy");
	
	ModLoader.addName(ChocoPork, "Choco Pork");
	ModLoader.addName(CookedChocoPork, "Cooked Choco Pork");
	
	ModLoader.addName(CocoaMesh, "Cocoa Mesh");
	ModLoader.addName(CocoaPowder, "Cocoa Powder");
	
	ModLoader.addName(ChocolateMilk, "Chocolate Milk");
	ModLoader.addName(HotChocolateMilk, "Hot Chocolate Milk");
	
	ModLoader.addName(ChocoBeef, "Choco Beef");
	ModLoader.addName(ChocoSteak, "Choco Steak");
	
	ModLoader.addName(BookOfTime, "Book Of Time");
	ModLoader.addName(BookOfHealing, "Book Of Healing");
	ModLoader.addName(BookOfExp, "Book Of Experience");
	ModLoader.addName(BookOfLightning, "Book Of Lightning");
	
	ModLoader.addName(MagicDust, "Magic Dust");
	ModLoader.addName(EarthEssence, "Earth Essence");
	ModLoader.addName(FireEssence, "fire Essence");
	ModLoader.addName(WaterEssence, "Water Essence");
	ModLoader.addName(WindEssence, "Wind Essence");
	
	ModLoader.addName(IronDust,  "Iron Dust");
	ModLoader.addName(GoldDust,  "Gold Dust");
	ModLoader.addName(MithrilDust,  "Mithril Dust");
	ModLoader.addName(SilverDust,  "Silver Dust");
	ModLoader.addName(CoalDust,  "Coal Dust");
	
	ModLoader.addName(Hammer, "Hammer");
	ModLoader.addName(MixedIronDust, "Mixed Iron Dust");
	ModLoader.addName(UnworkedSteelIngot, "Unworked Steel Ingot");
	...
	ModLoader.addName(ObsidianMultiTool, "Obsidian Multi Tool");
	ModLoader.addName(DiamondStick, "Diamond Stick");
	
	ModLoader.addName(DragonStonePickaxe, "DragonStone Pickaxe");
	ModLoader.addName(DragonStoneAxe, "DragonStone Axe");
	ModLoader.addName(DragonStoneShovel, "DragonStone Shovel");
	ModLoader.addName(DragonStoneSword, "DragonStone Sword");
	ModLoader.addName(DragonStoneHoe, "DragonStone Hoe");
	ModLoader.addName(DragonEggShard, "Dragon Egg Shard");
	...
	ModLoader.registerBlock(Duplicator);
	ModLoader.registerBlock(Alloynizer);
	...
	ModLoader.registerTileEntity(net.minecraft.src.CocoCraft.Misc.TileEntityDuplicator.class, "Duplicator");
	ModLoader.registerTileEntity(net.minecraft.src.CocoCraft.Misc.TileEntityAlloynizer.class, "Alloynizer");
	...
	ModLoader.addShapelessRecipe(new ItemStack(CocoIngot, 9), new Object[] {new ItemStack(CocoBlock)});
	
	/** MithrilBlocks **/
	ModLoader.addRecipe(new ItemStack(MithrilBlock, 1), new Object[] {"111", "111", "111", Character.valueOf('1'), MithrilIngot});
	ModLoader.addShapelessRecipe(new ItemStack(MithrilIngot, 9), new Object[] {new ItemStack(MithrilBlock)});
	
	/** SilverBlocks **/
	ModLoader.addRecipe(new ItemStack(SilverBlock, 1), new Object[] {"111", "111", "111", Character.valueOf('1'), SilverIngot});
	ModLoader.addShapelessRecipe(new ItemStack(SilverIngot, 9), new Object[] {new ItemStack(SilverBlock)});
	
	/** AmethystBlocks **/
	ModLoader.addRecipe(new ItemStack(AmethystBlock, 1), new Object[] {"111", "111", "111", Character.valueOf('1'), AmethystGem});
	ModLoader.addShapelessRecipe(new ItemStack(AmethystGem, 9), new Object[] {new ItemStack(AmethystBlock)});
	...
	ModLoader.addRecipe(new ItemStack(Duplicator, 1), new Object[] {"111", "121", "111", Character.valueOf('1'), Block.blockDiamond, Character.valueOf('2'), Block.blockSteel});
	...
	////Debug
	//ModLoader.addRecipe(new ItemStack(Item.flintAndSteel, 1), new Object[]{" 1", "  ", Character.valueOf('1'), Block.planks});
	...
	/** Generating Ores 'n' stuff. **/
	public void generateSurface(World world, Random rand, int baseX, int baseZ, GenerateOres gen)
	{
	...
	/** Putting Entities in the world **/
	public void addRenderer(Map map)
	{
		map.put(EntityChocoPig.class, new RenderChocoPig(new ModelChocoPig(), null, 0.5F));
		map.put(EntityChocoCow.class, new RenderChocoCow(new ModelChocoCow(), 0.5F));
	}
	
	
    public void load() {
    	/** Preloads textures, if not doing this, bugs will occure. **/
    	MinecraftForgeClient.preloadTexture("/CC/Blocks.png");
    	MinecraftForgeClient.preloadTexture("/CC/Items.png");
    	MinecraftForgeClient.preloadTexture("/CC/Armor/coco_1.png");
    	MinecraftForgeClient.preloadTexture("/CC/Armor/coco_2.png");
    	MinecraftForgeClient.preloadTexture("/CC/Armor/mithril_1.png");
    	MinecraftForgeClient.preloadTexture("/CC/Armor/mithril_2.png");
    	MinecraftForgeClient.preloadTexture("/CC/Armor/silver_1.png");
    	MinecraftForgeClient.preloadTexture("/CC/Armor/silver_2.png");
    	MinecraftForgeClient.preloadTexture("/CC/Armor/amethyst_1.png");
    	MinecraftForgeClient.preloadTexture("/CC/Armor/amethyst_2.png");
    	MinecraftForgeClient.preloadTexture("/CC/Armor/alloy_1.png");
    	MinecraftForgeClient.preloadTexture("/CC/Armor/alloy_2.png");
    	MinecraftForgeClient.preloadTexture("/CC/Armor/extremeAlloy_1.png");
    	MinecraftForgeClient.preloadTexture("/CC/Armor/extremeAlloy_2.png");
    	MinecraftForgeClient.preloadTexture("/CC/Mobs/ChocoPigSaddled.png");
    	MinecraftForgeClient.preloadTexture("/CC/Mobs/ChocoPig.png");
    	
    	/** Sets the strength of tools, 3 is diamond, 2 iron, 1 wood, I think. **/
	...
	/** Sets all the ids for blocks and items, changable in the config. **/
    public static int configurationProperties(Configuration config)
    {
    	...
    	//IngotBlocksID = Integer.parseInt(configuration.getOrCreateBlockIdProperty("IngotBlocksID", 174).value);
    	CocoBlockID = Integer.parseInt(configuration.getOrCreateBlockIdProperty( "IngotBlockID" , 174).value);	
    	...
    	DuplicatorID = Integer.parseInt(configuration.getOrCreateBlockIdProperty( "DuplicatorID" , 185).value);
    	AlloynizerID = Integer.parseInt(configuration.getOrCreateBlockIdProperty("AlloynizerID", 186).value);
    	...
    	BookOfLightningID = Integer.parseInt(configuration.getOrCreateIntProperty("BookOfLightningID", config.CATEGORY_ITEM, 629).value);
    ...
    @Override
    public String getVersion(){return "CocoCraft v1.9.7";}
	...
	public Object getGuiElement(int ID, EntityPlayer player, World world, int x, int y, int z)
	{
		...
		if(tile != null)
		{
			switch(ID)
			{
			case 0 : return new GuiCrusher(player.inventory, ((TileEntityCrusher)tile));
			case 1 : return new GuiCompressor(player.inventory, ((TileEntityCompressor)tile));
			case 2 : return new GuiSilverFurnace(player.inventory, ((TileEntitySilverFurnace)tile));
			case 3 : return new GuiDuplicator(player.inventory, ((TileEntityDuplicator)tile));
			case 4 : return new GuiAlloynizer(player.inventory, ((TileEntityAlloynizer)tile));
			}
