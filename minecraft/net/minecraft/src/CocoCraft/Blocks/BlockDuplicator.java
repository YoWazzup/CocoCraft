...
public class BlockDuplicator extends BlockContainer
{
    ...
    public BlockDuplicator(int id, boolean flag)
    {
	...
	public boolean blockActivated(World world, int i, int j, int k, EntityPlayer entityplayer)
    {
        ...
        if(!world.isRemote)
        {
            entityplayer.openGui(mod_CocoCraft.getInstance(), 3, world, i, j, k);
            return true;
        }
        return true;
    }
    ...
    public void onBlockRemoval(World world, int x, int y, int z)
    {
        ...
        {
        	TileEntityDuplicator tile = (TileEntityDuplicator)world.getBlockTileEntity(x, y, z);
