...
public class GuiCompressor extends GuiContainer{
	...
	private TileEntityCompressor crusherInventory;
	
	public GuiCompressor(InventoryPlayer inventoryplayer, TileEntityCompressor tile)
	{
	...
	{
		fontRenderer.drawString("Compressor", 60, 6, 0x404040);
