...
public class TileEntityCompressor extends TileEntity implements IInventory, ISidedInventory{
        ...
        if (!this.worldObj.isRemote)
        {
            if (this.CompressorBurnTime == 0 && this.canSmelt())
            {
                ...
                if (this.CompressorBurnTime > 0)
                {
                    ...
                    {
                        if (this.CompressorItemStacks[1].getItem().func_46056_k())
                        {
	...
	public void smeltItem()
    {
        if (this.canSmelt())
        {
            ...
            if (this.CompressorItemStacks[0].getItem().func_46056_k())
            {
	...
	public static int getItemBurnTime(ItemStack par1ItemStack)
    {
        ...
        else
        {
            ...
            return var1 < 256 && Block.blocksList[var1].blockMaterial == Material.air ? 0 : (var1 == mod_CocoCraft.MagicDust.shiftedIndex ? 1800 :  ModLoader.addAllFuel(par1ItemStack.itemID, par1ItemStack.getItemDamage()));
        }
    }
